...
{
    [TestClass()]
    public class BestFitDecreasingSchedulerTests
    {
        [TestMethod()]
        public void ScheduleConferenceTest()
        {
            ...
            BestFitDecreasingScheduler bestFitDecreasingScheduler = new BestFitDecreasingScheduler();
            var conference = bestFitDecreasingScheduler.ScheduleConference(conferenceEvents);
